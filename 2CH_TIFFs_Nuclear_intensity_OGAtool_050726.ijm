...
for (i=0; i<list.length; i++){
	...
	run("Duplicate...", " ");
	//threshold for d174n cells, manually determine and change values below
	//setThreshold(320, 65535, "raw");
	//threshold for wt cells, manually determine and change values below
	setThreshold(240, 65535, "raw");
